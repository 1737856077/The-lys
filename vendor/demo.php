...
class wxRedPack {
    ...
    //public static $re_openid = "";                  //openid
    //public static $total_amount = "100";                                          //红包金额
    public static $total_num = "1";                                             //红包发放总人数
    public static $wishing = "恭喜发财^_^";                              //红包祝福语
    public static $client_ip = "0.0.0.0";                                       //调用接口的机器Ip地址
    public static $act_name = "恭喜发财";                                //活动名称
    public static $remark = "";                              //备注信息
