                ...
                <div class="layui-card-header">
                    ...
                    <div class="layui-input-inline" style="width:80px;float: right;">
                        <button class="layui-btn layui-btn-sm layui-btn-normal" id="add_banner">
                        	<a href="?m=config&c=notice_add" style="text-decoration:none; color:#fff;">添加内容</a>
                        </button>
                    </div>
                </div>
    ...
    layui.use(['element','layer','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'n_title', title:'标题',align:'center'}
                ,{field:'n_img', title:'缩略图',align:'center'}
                ,{field:'n_desc', title:'描述',align:'center'}
