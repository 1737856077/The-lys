...
<div class="layui-fluid" style="margin: 10px 0px;">
    ...
    <script type="text/html" id="barDemo">
        {{# if(d.status == '1'){ }}
            <a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="edit">确认</a>
        {{# } }}
...
<script>
    layui.use(['element', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        table.render({
            ...
            , limit: 20
            , cols: [[
                {field: 'id', title: 'ID', width: 100, unresize: true, align: 'center'}
                , {field: 'u_user', title: '激活会员', width: 200, align: 'center'}
                , {field: 's_user', title: '收款会员', width: 200, align: 'center'}
                , {field: 'level', title: '申请阶段', align: 'center'}
                , {field: 'l_pay_img', title: '付款凭证', align: 'center'}
                , {field: 'c_time', title: '申请时间', align: 'center'}
                , {field: 'd_time', title: '完成时间', align: 'center'}
                , {field: 's_status', title: '状态', align: 'center'}
