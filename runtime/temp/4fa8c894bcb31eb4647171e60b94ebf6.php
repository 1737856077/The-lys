<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\phpStudy\PHPTutorial\WWW\sy/business/gift\view\gift.gift.html";i:1555987406;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                ...
                <div class="panel-body clearfix main-panel-body menu-fixed">
                    ...
                    <div class="right-content" style="min-height: 490px;">
                        <ul class="we7-page-tab">
                            <li class="active"><a
                                    href="https://weixin.zijiahei.com/web/index.php?c=user&amp;a=display&amp;">礼品列表</a>
                            </li>
                        ...
                        <div class="keyword-list-head clearfix we7-margin-bottom">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo url('gift/add'); ?>"
                                   class="btn btn-primary">+添加礼品</a></div>
                        </div>
                        <table class="table we7-table table-hover table-manage vertical-middle ng-scope"
                            ...
                            <tr ng-repeat="user in users" ng-if="users" class="ng-scope">
                                <td class="text-left ng-binding" ng-bind="user.username"><?php echo $vo['title']; ?></td>
                                <td class="text-left ng-binding" ng-bind="user.username">
                                    <img src="/static/uploads/business/<?php echo $vo['images']; ?>" alt="">
                                </td>
                                <td class="color-default ng-binding" ng-bind="user.maxaccount"><?php echo $vo['total']; ?></td>
                                <td class="color-default ng-binding" ng-bind="user.maxwxapp"><?php echo $vo['integral']; ?></td>
                                <td class="color-default ng-binding" ng-bind="user.maxwebapp"><?php echo date("Y-m-d",$vo['create_time']); ?></td>
                                <td>
                                    <span ng-bind="user.joindate" class="ng-binding"><?php echo date("Y-m-d",$vo['updata_time']); ?></span>
                                </td>
                                <td>
                                    <span ng-bind="user.joindate" class="ng-binding"><?php echo $vo['data_desc']; ?></span>
                                </td>
                                <td>
                                    <span ng-bind="user.endtime" class="ng-binding"><?php echo !empty($vo['data_status'])?'上架':'下架'; ?></span>
                                </td>
                                <td class="vertical-middle table-manage-td">
                                    <div class="link-group ng-scope" ng-if="!user.founder">
                                        <a href="<?php echo url('gift/edit'); ?>?id=<?php echo $vo['id']; ?>">编辑</a>
                                        <a href="<?php echo url('gift/status'); ?>?id=<?php echo $vo['id']; ?>"><?php echo !empty($vo['data_status'])?'下架':'上架'; ?></a>
                                    </div>
                                </td>
                            </tr>
