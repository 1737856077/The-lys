<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\phpStudy\PHPTutorial\WWW\sy/business/qrcode\view\createqrcode.add.html";i:1555919983;}*/ ?>
...
<div class="container">
    ...
    <div class="cont_title">　
        你当前的位置：商家管理 - <a href="">积分码列表</a> - 生成积分码
    ...
    <div class="con">
        ...
        <div class="conlist">
            <form action="/business.php/qrcode/createqrcode/insert" method="post" enctype="multipart/form-data" name="form1" id="form1"
                  onSubmit="javascript:return subfun();">
                <input type="hidden" name="actionType" id="actionType" value="0"/>
                <table class="listtable">
                    <tr class="tr1">
                        <td colspan="2" class="tit">生成积分码</td>
                    </tr>
                    <tr class="tr1">
                    ...
                    <tr class="tr1">
                        ...
                        <td class="tdr" style="padding-top:5px;">
                            <select name="size">
                                <?php $__FOR_START_26778__=1;$__FOR_END_26778__=10;for($i=$__FOR_START_26778__;$i < $__FOR_END_26778__;$i+=1){ ?>
...
<script>
    ...
    $("#sheng").change(function () {
        ...
        $.ajax({
            type: 'post',
            url: '/business.php/qrcode/createqrcode/shi',
            data: 'shi=' + $('#sheng').val(),
            dataType: "json",
